-- Base mínima para una app con productos, pedidos y pagos.
-- No se implementa Mercado Pago todavía; solo se prepara la estructura segura para la siguiente fase.
...
with check (
  ...
  and NEW.preference_id = OLD.preference_id
